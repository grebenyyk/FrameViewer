...
Live calculation of pointer 2θ value is implemented according to the [book](https://onlinelibrary.wiley.com/doi/book/10.1002/9781119356080) by Bob He and is based on the instrument parameters parsed from the frame header (detector distance and detector center). Note that 2θ readings may be unreliable, as no refinement of the instrument parameters is implemented.
